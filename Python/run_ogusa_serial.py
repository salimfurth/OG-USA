...
#    }, }
    ...
    user_params = {'start_year':2017, 'debt_ratio_ss':1.0}
...
#    tpi_firm_r_reform[0] = 0.0526
#    tpi_firm_r_reform[1] = 0.0523
#    tpi_firm_r_reform[2] = 0.0520
#    tpi_firm_r_reform[3] = 0.0517

    user_params = {'start_year':2017, 'debt_ratio_ss':1.0, 'k_wedge':0.0}  #'tpi_firm_r': tpi_firm_r_reform
